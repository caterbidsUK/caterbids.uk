...
export const CATERING_CATEGORIES: CaterBidsCategory[] = [
  ...
  {
    title: "Bar, Servery & Furniture",
    slug: "bar-servery-and-furniture",
    description: "Back bars, serveries, counters, sinks, prep benches, shelving and dining furniture.",
    searchQuery: "commercial bar servery furniture fittings",
    subcategories: [
      "Back Bars & Bar Fittings",
      "Serveries & Counters",
      "Sinks & Sink Units",
      "Prep Tables & Benches",
      "Shelving & Racking",
