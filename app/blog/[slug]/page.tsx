  ...
  return (
    <section className="mt-6 rounded-[2rem] border border-[#FF6B00]/30 bg-[radial-gradient(circle_at_top_right,rgba(255,107,0,0.25),transparent_34%),linear-gradient(135deg,#062747,#001A35)] p-6 shadow-2xl sm:p-8">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-3">
        ...
        <Link href="/search" className="inline-flex min-h-14 items-center justify-center rounded-2xl border border-white/18 bg-white/8 px-5 text-sm font-black text-white transition hover:border-[#FF6B00]/55">
...
function TrustStrip() {
  const items = [
    ["Seller Verification", "Sellers verify their email address before listing.", ShieldCheck],
